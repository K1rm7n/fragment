<template>
  <div class="relative">
    <div class="lg:grid grid-cols-2 relative z-10">
      ...
      >
        <div class="space-y-2">
          <h2 class="text-3xl font-bold mb-5 text-dark">Kinesis</h2>
          <p>Simply the best animation engine</p>
          <p>
            Path:
            <code>/components/example/Kinesis.vue</code>
          </p>
          <p>
            Kinesis is easy to use component for interactive animations. On the
            <code>/plugins/kinesis.js</code> path you will find everything about
            registering a component in the application.
          </p>
          <p>Move the mouse over the interactive block to see the effect</p>
          <a
            href="https://aminerman.com/kinesis"
            target="_blank"
      ...
      <div class="relative clip-block-corner">
        <div class="z-10 bg-alt/[0.45] relative backdrop-blur-3xl h-full">
          <h3
            class="text-3xl font-bold mb-5 md:mb-0 text-light absolute top-10 left-10 z-10"
          >
            Move your mouse
          </h3>
          <kinesis-container
            class="h-full relative flex justify-center items-center emoji-container overflow-hidden"
          >
            <kinesis-element
              v-for="index in 30"
              :key="index"
              ...
              :style="{
                zIndex: 10 - index,
                opacity: 1 - (index - 1) / 30,
              }"
            >
              <div
                class="bg-gradient-to-br from-alt to-primary rounded-full shadow-2xl shadow-black"
                :class="{ '!shadow-xl': index === 1 }"
                :style="{
                  width: index * 30 + 'px',
                  height: index * 30 + 'px',
                }"
            ...
            <kinesis-element
              :strength="20"
              type="depth"
              class="absolute z-50 border-0 bg-dark/40 backdrop-blur-xl p-10 w-[calc(100%-5rem)] text-light font-black whitespace-nowrap clip-corner"
            >
              Some awsome card
            </kinesis-element>
          </kinesis-container>
